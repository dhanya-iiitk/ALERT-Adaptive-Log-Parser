...
from clustering.frequency_aware_cluster import two_stage_cluster_freq
...
def build_store_for_dataset(dataset: str, data_dir: str = "datasets",
    ...
    # Step 7: Frequency-aware clustering
    ...
    freq_counts = df["normalised"].value_counts().to_dict()
    frequencies = [freq_counts.get(u, 1) for u in unique_logs]
    labels = two_stage_cluster_freq(embeddings, unique_logs, frequencies, dist, dataset=dataset, n_clusters=n_clusters)
